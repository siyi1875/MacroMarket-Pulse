...
const REAL_MARKET_HISTORY = [
  // --- 2015 ---
  { date: '2015-01-01', cpi: 233.7, rate: 0.11, m2: 11.7, unemp: 5.7, sp500: 2058, nasdaq: 4736, bitcoin: 314, ethereum: 0.70 },
  { date: '2015-06-01', cpi: 238.6, rate: 0.13, m2: 11.9, unemp: 5.3, sp500: 2063, nasdaq: 5070, bitcoin: 262, ethereum: 0.85 },
  { date: '2015-12-01', cpi: 236.5, rate: 0.24, m2: 12.3, unemp: 5.0, sp500: 2043, nasdaq: 5007, bitcoin: 430, ethereum: 0.90 },

  // --- 2016 ---
  { date: '2016-06-01', cpi: 241.0, rate: 0.38, m2: 12.7, unemp: 4.9, sp500: 2098, nasdaq: 4842, bitcoin: 670, ethereum: 12.5 },
  { date: '2016-12-01', cpi: 241.4, rate: 0.54, m2: 13.1, unemp: 4.7, sp500: 2238, nasdaq: 5383, bitcoin: 960, ethereum: 8.0 },

  // --- 2017 (Crypto Bull Run) ---
  { date: '2017-03-01', cpi: 243.8, rate: 0.79, m2: 13.3, unemp: 4.4, sp500: 2362, nasdaq: 5911, bitcoin: 1080, ethereum: 50 },
  { date: '2017-06-01', cpi: 244.9, rate: 1.06, m2: 13.5, unemp: 4.3, sp500: 2423, nasdaq: 6140, bitcoin: 2480, ethereum: 260 },
  { date: '2017-12-15', cpi: 246.5, rate: 1.30, m2: 13.8, unemp: 4.1, sp500: 2675, nasdaq: 6930, bitcoin: 19400, ethereum: 720 },

  // --- 2018 (Trade War / Rate Hikes) ---
  { date: '2018-02-01', cpi: 248.9, rate: 1.42, m2: 13.9, unemp: 4.1, sp500: 2695, nasdaq: 7115, bitcoin: 9000, ethereum: 900 },
  { date: '2018-09-01', cpi: 252.4, rate: 2.00, m2: 14.1, unemp: 3.7, sp500: 2901, nasdaq: 7900, bitcoin: 6500, ethereum: 280 },
  { date: '2018-12-24', cpi: 251.2, rate: 2.40, m2: 14.3, unemp: 3.9, sp500: 2351, nasdaq: 6192, bitcoin: 3800, ethereum: 130 },

  // --- 2019 (Fed Pivot) ---
  { date: '2019-06-01', cpi: 256.1, rate: 2.38, m2: 14.7, unemp: 3.6, sp500: 2940, nasdaq: 8000, bitcoin: 8500, ethereum: 260 },
  { date: '2019-12-31', cpi: 256.9, rate: 1.55, m2: 15.3, unemp: 3.6, sp500: 3230, nasdaq: 8972, bitcoin: 7200, ethereum: 130 },

  // --- 2020 (COVID) ---
  { date: '2020-02-19', cpi: 258.6, rate: 1.58, m2: 15.4, unemp: 3.5, sp500: 3386, nasdaq: 9817, bitcoin: 9600, ethereum: 280 },
  { date: '2020-03-23', cpi: 258.1, rate: 0.05, m2: 16.0, unemp: 14.7, sp500: 2237, nasdaq: 6860, bitcoin: 6400, ethereum: 130 },
  { date: '2020-08-01', cpi: 259.9, rate: 0.09, m2: 18.3, unemp: 8.4, sp500: 3500, nasdaq: 11700, bitcoin: 11500, ethereum: 380 },
  { date: '2020-12-31', cpi: 260.4, rate: 0.09, m2: 19.1, unemp: 6.7, sp500: 3756, nasdaq: 12888, bitcoin: 29000, ethereum: 730 },

  // --- 2021 (Money Printer) ---
  { date: '2021-04-15', cpi: 267.0, rate: 0.07, m2: 20.1, unemp: 6.1, sp500: 4180, nasdaq: 14000, bitcoin: 63000, ethereum: 2400 },
  { date: '2021-11-10', cpi: 277.9, rate: 0.08, m2: 21.3, unemp: 4.2, sp500: 4700, nasdaq: 16200, bitcoin: 68700, ethereum: 4800 },

  // --- 2022 (Inflation Fight) ---
  { date: '2022-01-03', cpi: 281.1, rate: 0.08, m2: 21.6, unemp: 4.0, sp500: 4796, nasdaq: 15832, bitcoin: 47000, ethereum: 3800 },
  { date: '2022-06-15', cpi: 296.3, rate: 1.58, m2: 21.6, unemp: 3.6, sp500: 3666, nasdaq: 10646, bitcoin: 20000, ethereum: 1100 },
  { date: '2022-10-13', cpi: 298.0, rate: 3.08, m2: 21.4, unemp: 3.7, sp500: 3491, nasdaq: 10088, bitcoin: 19000, ethereum: 1200 },
  { date: '2022-12-31', cpi: 296.7, rate: 4.33, m2: 21.2, unemp: 3.5, sp500: 3839, nasdaq: 10466, bitcoin: 16500, ethereum: 1190 },

  // --- 2023 (AI Boom) ---
  { date: '2023-03-13', cpi: 301.8, rate: 4.58, m2: 21.0, unemp: 3.5, sp500: 3855, nasdaq: 11188, bitcoin: 24000, ethereum: 1680 },
  { date: '2023-07-31', cpi: 305.6, rate: 5.33, m2: 20.9, unemp: 3.5, sp500: 4588, nasdaq: 14346, bitcoin: 29200, ethereum: 1860 },
  { date: '2023-10-27', cpi: 307.6, rate: 5.33, m2: 20.8, unemp: 3.8, sp500: 4117, nasdaq: 12643, bitcoin: 34000, ethereum: 1780 },
  { date: '2023-12-29', cpi: 306.7, rate: 5.33, m2: 20.8, unemp: 3.7, sp500: 4769, nasdaq: 15011, bitcoin: 42000, ethereum: 2300 },

  // --- 2024 (Granular Monthly Data for Precision) ---
  { date: '2024-01-31', cpi: 308.4, rate: 5.33, m2: 20.8, unemp: 3.7, sp500: 4845, nasdaq: 15164, bitcoin: 42500, ethereum: 2280 },
  { date: '2024-02-29', cpi: 310.3, rate: 5.33, m2: 20.8, unemp: 3.9, sp500: 5096, nasdaq: 16091, bitcoin: 61000, ethereum: 3300 },
  { date: '2024-03-31', cpi: 312.3, rate: 5.33, m2: 20.9, unemp: 3.8, sp500: 5254, nasdaq: 16379, bitcoin: 71000, ethereum: 3600 },
  { date: '2024-04-30', cpi: 313.5, rate: 5.33, m2: 20.9, unemp: 3.9, sp500: 5035, nasdaq: 15657, bitcoin: 60000, ethereum: 3000 }, // Correction
  { date: '2024-05-31', cpi: 314.0, rate: 5.33, m2: 21.0, unemp: 4.0, sp500: 5277, nasdaq: 16735, bitcoin: 67500, ethereum: 3750 },
  { date: '2024-06-30', cpi: 314.1, rate: 5.33, m2: 21.0, unemp: 4.1, sp500: 5460, nasdaq: 17732, bitcoin: 62000, ethereum: 3400 },
  { date: '2024-07-31', cpi: 314.5, rate: 5.33, m2: 21.1, unemp: 4.3, sp500: 5522, nasdaq: 17599, bitcoin: 66000, ethereum: 3300 },
  { date: '2024-08-05', cpi: 314.8, rate: 5.33, m2: 21.1, unemp: 4.2, sp500: 5186, nasdaq: 16200, bitcoin: 54000, ethereum: 2300 }, // Yen Carry Flash Crash
  { date: '2024-08-30', cpi: 314.8, rate: 5.33, m2: 21.1, unemp: 4.2, sp500: 5648, nasdaq: 17713, bitcoin: 59000, ethereum: 2500 },
  { date: '2024-09-18', cpi: 315.0, rate: 4.83, m2: 21.2, unemp: 4.1, sp500: 5618, nasdaq: 17573, bitcoin: 60000, ethereum: 2350 }, // 50bps Cut
  { date: '2024-09-30', cpi: 315.3, rate: 4.83, m2: 21.2, unemp: 4.1, sp500: 5762, nasdaq: 18189, bitcoin: 63300, ethereum: 2600 },
  { date: '2024-10-31', cpi: 315.5, rate: 4.83, m2: 21.2, unemp: 4.1, sp500: 5705, nasdaq: 18095, bitcoin: 70000, ethereum: 2500 }, // Pre-Election
  { date: '2024-11-06', cpi: 315.6, rate: 4.83, m2: 21.2, unemp: 4.1, sp500: 5929, nasdaq: 18983, bitcoin: 75000, ethereum: 2800 }, // Election Pump
